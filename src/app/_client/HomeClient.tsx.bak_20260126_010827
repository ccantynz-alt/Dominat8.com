  ...
  if (kind === "wp") {
    return (
      <svg {...common} aria-hidden="true">
        ...
        <path d="M7.5 9.5c.8 0 1.3.5 1.6 1.2l2.2 6 1.6-4.4-1-2.8c-.2-.6.2-1.1.8-1.1.5 0 .8.3 1 .8l2.1 6.2"
...
export default function HomeClient() {
  ...
  const trust =
    probeOk === null ? "Checking…" : probeOk ? "LIVE_OK" : "WARN";
    ...
    <>
      <style>{`
        ...
        *{ box-sizing:border-box; }
        ...
        /* Photo-like background without assets */
        .bg .layer1{
        ...
        /* “subject” silhouette glow (feels like a person on right) */
        .bg .subject{
          position:absolute;
          right: -120px;
          bottom: -140px;
        ...
        .proofLine b{ color: rgba(255,255,255,.74); font-weight: 900; }

        /* Right “floating stack” like SiteGround */
        .stack{
          position: relative;
          width: 100%;
          max-width: 520px;
        ...
        @media (prefers-reduced-motion: reduce){
          .bg .layer1{ transform:none !important; }
          .bg .subject{ transform:none !important; }
          .stackCard, .btn{ transition:none !important; }
          .stackCard:hover{ transform:none !important; }
        }
          ...
          <div className="container">
            <div className="heroGrid">
              <div>
                ...
                <h1 className="h1">
                  Build, host, grow{" "}
                  <span style={{ color: "rgba(255,255,255,.96)" }}>your online presence</span>
                </h1>

                <p className="sub">
                  Your all-in-one platform for online success — generated with structure, proof markers, and publish-ready outputs.
                </p>
              ...
              <div className="stack" aria-label="Action stack">
                ...
                <div className="proofLine" style={{ marginTop: 10, color: "rgba(255,255,255,.52)" }}>
                  Tip: if you ever doubt cache, open with <b>?ts=123</b>
                </div>
              </div>
            </div>
          </div>
