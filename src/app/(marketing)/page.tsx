...
const BUILD_STAMP = "BUILD_20260124_213028";
const DEPLOY_ID = "7cafaf98a276";
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="fixed left-4 top-4 z-[9999] rounded-2xl border border-white/20 bg-black/70 px-4 py-3 text-left shadow-sm">
        ...
        <div className="mt-1 text-xs text-white/50">If you don’t see this box, you’re not on the deployed route.</div>
      </div>

      {/* HERO = ENTIRE VIEWPORT */}
      <section className="relative flex min-h-[100svh] w-screen items-center justify-center overflow-hidden">
        {/* Loud background to prove change */}
        ...
        <div className="relative mx-auto w-full px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-4 text-xs uppercase tracking-[0.28em] text-white/60">
              Dominat8 — Flagship Homepage Probe
            </div>

            <h1 className="text-[clamp(3.2rem,7vw,6.2rem)] font-semibold leading-[1.02] tracking-tight text-white">
              Full-screen hero.
              <span className="block text-white/80">No boxes.</span>
              <span className="block">No doubt.</span>
            </h1>

            <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-white/70">
              This page is intentionally extreme. If this deploy is live, you will see the fixed overlay and this hero will fill the viewport.
            </p>
