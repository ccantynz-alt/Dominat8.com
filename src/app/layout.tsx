...
export const metadata: Metadata = {
  title: "Dominat8 â€” AI Website Builder",
  description:
        ...
        <footer className="border-t bg-white">
          <div className="mx-auto max-w-6xl px-4 py-8">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="text-xs opacity-70">Â© {new Date().getFullYear()} Dominat8.com â€” Built on Vercel</div>
            </div>
            <div className="mt-4 flex flex-wrap gap-3 text-xs opacity-80">
              ...
              <span data-x-dominat8-build-badge>
                Build: <span className="font-mono">{__BUILD_SHA_SHORT}</span> Â· Env: <span className="font-mono">{__VERCEL_ENV}</span>
              </span>
